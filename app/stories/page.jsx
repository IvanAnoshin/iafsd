          ...
          <div className="storyHub-stage storyHub-stageViewer is-desktopOverlay is-cover">
            ...
            {!hasMedia ? (
              <div className="storyHub-emptyMediaState">
                ...
                <p>{active.subtitle || 'У момента нет описания.'}</p>
              </div>
            ) : null}
...
export default function StoriesPage() {
  ...
  const stories = useMemo(() => (Array.isArray(storiesPayload.items) ? storiesPayload.items : []).filter((item) => isRenderableMoment(item) && item?.is_renderable !== false), [storiesPayload.items]);
