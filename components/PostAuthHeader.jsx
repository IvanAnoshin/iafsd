...
<GearIcon />
              ...
              <div className="profile-menu-dropdown" role="menu" hidden={!menuOpen}>
                <button className="profile-menu-btn" type="button" role="menuitem" onClick={() => { setMenuOpen(false); onEdit?.(); }}>
